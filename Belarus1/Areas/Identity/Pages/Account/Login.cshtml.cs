...
namespace Belarus1.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<BelarusUser> signInManager, ILogger<LoginModel> logger)
        {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, translate.TranslateString(ErrorMessage));
            }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    _logger.LogInformation("User logged in." + User.Identity.Name);
